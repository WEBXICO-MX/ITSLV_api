...
<html lang="es">
<head>
<title>ITSLV &#124; Instituto Tecnológico  Superior de Villa la Venta &#124; Login</title>
<meta charset="UTF-8">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				<h2 class="text-center login-title">ITSLV &#124; Instituto Tecnológico  Superior de Villa la Venta</h2>
